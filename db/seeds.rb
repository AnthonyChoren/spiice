...
bertrand = User.new(email: "designer4@gmail.com", password:"azerty", first_name: "Bertrand", last_name: "Broussac", phone_number:"0615398752", company:"LeWagon", city:"Nantes", country:"France", role: 1, bio:"Webdesigner with 10 years of success, if you want the best don't miss me I totally agree with my world renown ! ")
...
benoit = User.new(email: "designer6@gmail.com", password:"azerty", first_name: "Benoit", last_name: "Bisou", phone_number:"0615398752", company:"Grinch Ltd", city:"Bordeaux", country:"France", role: 1, bio:"The best since the beginning, my work is the very definition of perfection, if you want the success you will need my help ")
henri = User.new(email: "designer7@gmail.com", password:"azerty", first_name: "Henri", last_name: "Kattre", phone_number:"0615398741", company:"FreeLance", city:"Lilles", country:"France", role: 1, bio:"Designer since so many years that I can remember why I am so good in web-designing ")
jonathan = User.new(email: "designer8@gmail.com", password:"azerty", first_name: "Jonathan", last_name: "Seraterminé", phone_number:"0615398747", company:"PacificKing", city:"Bordeaux", country:"France", role: 1, bio:"I love Web-Design, I always work on time with joy and happiness ")
sabrina = User.new(email: "designer9@gmail.com", password:"azerty", first_name: "Sabrina", last_name: "Trachsler", phone_number:"0615398732", company:"RicolaDesign", city:"Zurich", country:"Switzerland", role: 1, bio:"I am Psychologist of web-designing, I master the UX mind his application and I speak French very well")
boris = User.new(email: "designer10@gmail.com", password:"azerty", first_name: "Boris", last_name: "Kayar", phone_number:"0615398741", company:"LeWagon", city:"Paris", country:"France", role: 1, bio:" UX, UI, Web-Designer, Teacher, Entrepreneur... If you want more contact me ! ")

bill = User.new(email: "client1@gmail.com", password:"azerty", first_name: "Bill", last_name: "Gates", phone_number:"0654324559", company:"Microsoft", city:"Redmond", country:"USA", role: 0, bio:"Project owner from a major enterprise, looking for a very disciplined web designer who doesn't ask too many questions, especially on the merits. Anyway we are looking for the best. ")
charly = User.new(email: "client2@gmail.com", password:"azerty", first_name: "Charly", last_name: "Carol", phone_number:"0654324556", company:"Microsoft", city:"Marseille", country:"France", role: 0, bio:"Project owner looking for a good webdesigner, hard worker and easy to drive. ")
chloe = User.new(email: "client3@gmail.com", password:"azerty", first_name: "Chloé", last_name: "Christine", phone_number:"0634568998", company:"Amazon", city:"Montpellier", country:"France", role: 0, bio:"Looking for a good webdesigner, project owner for a long-time project in World Suppremacy E-Busines")
vanessa = User.new(email: "client4@gmail.com", password:"azerty", first_name: "Vanessa", last_name: "Rapport", phone_number:"0634568997", company:"Amazon", city:"Bordeaux", country:"France", role: 0, bio:"Looking for nice Designer with good skills and very smart mind")
sebastien = User.new(email: "client5@gmail.com", password:"azerty", first_name: "Sebastien", last_name: "Sautier", phone_number:"0654324556", company:"LeWagon", city:"Paris", country:"France", role: 0, bio:"We have a very big project for smart designers, it's about 1 year of hard work but you will have no more than 9 weeks to do your best, only with Ruby, don't panic you will be helped by a very efficient team.")
jeanne = User.new(email: "client6@gmail.com", password:"azerty", first_name: "Jeanne", last_name: "Darque", phone_number:"0634568995", company:"Amazon", city:"Rouen", country:"France", role: 0, bio:"I 'm looking for a real good Product Owner for my project. I need good technical skills ")
pilou = User.new(email: "client7@gmail.com", password:"azerty", first_name: "Pilou", last_name: "Pilou", phone_number:"0634568981", company:"PronostkR", city:"Toulon", country:"France", role: 0, bio:"Start-Up 4.0 with a real project looking for the best Designer and other pro in the game. Players only")
quentin = User.new(email: "client8@gmail.com", password:"azerty", first_name: "Quentin", last_name: "DeMalherbe", phone_number:"0634568952", company:"AristocraticWeb", city:"Versailles", country:"France", role: 0, bio:"Looking for real Designers with great selflessnes and greatness of mind to form a high-end team. ")
vladimir = User.new(email: "client9@gmail.com", password:"azerty", first_name: "vladimir", last_name: "Put-in", phone_number:"06345689", company:"KremlinFamily", city:"Mockba", country:"Russia", role: 0, bio:"I am looking for really good and secret professionnals for a very marvellous project, I autrhorize you to come and apply. ")
donald = User.new(email: "client10@gmail.com", password:"azerty", first_name: "Donald", last_name: "T", phone_number:"0634568932", company:"Whitehouse", city:"Wahington", country:"USA", role: 0, bio:"I'm looking for American Designer whatever they are good or not. Make my WebSite great again ! ")
didier.save!
dylan.save!
francoise.save!
bertrand.save!
...
request4 = Request.new(message: "Good morning Mister Sautier, your project reminds me my bootcamp, I want to work with you and your efficient team, 9 weeks is enough for me ! Greetings-- Anthony")
request4.project = j
